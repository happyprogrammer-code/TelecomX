...
import './glimpse.css'
import { mainTv, lightBlueTv, blueTv, glimpseTop } from './img'
    ...
    return (
       <section className="glimpse-main">
           {/* <div className="glimpse-title">
            ...
            <div className="glimpse-top-img">
   
            <img src={glimpseTop} alt="" srcset=""/>
            <div className="glimpse-title-boxx">
                <h1>Glimpse of our product</h1>
            </div>
            </div>
